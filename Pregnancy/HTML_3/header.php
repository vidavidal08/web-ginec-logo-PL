...
<html lang="en">
    <head>
        ...
        <title>Centro Especialista en Ginecología y Obstetricia-CEGO</title>

        <!-- plugins -->
        <link rel="stylesheet" type="text/css" href="css/plugin.css" />
        
        <!-- Revolution Slider -->		
		<link rel="stylesheet" type="text/css" href="vendor/revolution-slider/revolution/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css">
  ...
  margin-right: .1rem;
	...
	<nav hidden class="nav-white header-fancy">
         ...
         <!--   <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <a class="dropdown-item" href="#">Honorarios Médicos</a>
                      <a class="dropdown-item" href="#">Pediatra</a>
                      <a class="dropdown-item" href="#">Consulta de Seguimiento y asesoria de Planificación Familiar</a>
                      <a class="dropdown-item" href="#">Acompañamiento del Familiar</a>
